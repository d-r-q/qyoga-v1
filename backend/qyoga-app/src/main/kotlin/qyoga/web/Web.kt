...
fun ErrorBody(failure: GenericFailure<*>) =
...
suspend fun PipelineContext<*, ApplicationCall>.respond(res: Outcome<Any>) {
    when (res) {
        is Ok -> {
        ...
        is NotFound -> {
            ...
            call.respond(HttpStatusCode.NotFound, ErrorBody(message = res.message))
        }
        is GenericSuccess -> {
